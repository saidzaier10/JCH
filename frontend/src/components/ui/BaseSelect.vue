        ...
        <div class="relative rounded-md shadow-sm">
            <select :id="id" :value="modelValue" @change="$emit('update:modelValue', $event.target.value)"
                :disabled="disabled" :required="required" v-bind="$attrs" :class="[
                    'block w-full rounded-lg border-gray-300 bg-white focus:bg-white focus:ring-2 focus:ring-judo-blue focus:border-judo-blue sm:text-sm transition-all duration-200 py-3 appearance-none',
